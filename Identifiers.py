...
class RegistrationPageIdentifiers(object):
    ...
    ERROR_LAST_NAME = (By.XPATH, '(//div[@class = "ant-form-item-explain-error"])[1]')
    ERROR = (By.XPATH, '//div[@class="ant-form-item-explain-error"]')
    ERROR_PASSWORD = (By.XPATH, '//*[@id="registration"]/div[1]/div/div[2]/div/div[2]/div[2]/div')
...
class LoginPageIdentifiers(object):
    ...
    LOGIN_PAGE_TITLE = (By.XPATH, '//h2[text() = "Login to Canonizer"]')
    ...
    OTP_TITLE_TEXT = (By.XPATH, '//h2[text() = "Log in One Time Verification Code"]')
    OTP_SUBMIT_BUTTON = (By.XPATH, '//*[@id="submit-otp-btn"]/span[1]')
    ENTER_OTP_ERROR = (By.XPATH, '//*[@id="registration"]/div[1]/div[2]/div/div[2]/div')
    EMAIL_ERROR_MESSAGE = (By.XPATH, '//*[@id="login_form"]/div[1]/div[2]/div[2]/div')
    PASSWORD_ERROR_MESSAGE = (By.XPATH,'//*[@id="login_form"]/div[2]/div[2]/div[2]/div')
    LOGIN_TITLE = (By.XPATH, '//h2[text() = "Log in to Canonizer"]')
    REGISTER_PAGE_TITLE = (By.XPATH, '//h2[text() = "Register Now on Canonizer"]')
