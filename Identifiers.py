...
class BrowsePageIdentifiers(object):
    ...
    GENERAL = (By.ID, 'name-space-0')
    #CORPORATIONS = (By.XPATH, '/html/body/div[3]/div/div/div/div[2]/div[1]/div/div/div[8]/div')
    CORPORATIONS = (By.ID, 'name-space-1')
    CRYPTOCURRENCY = (By.ID, 'name-space-2')
    FAMILY = (By.ID, 'name-space-3')
    FAMILYJESPERSON = (By.ID, 'name-space-4')
    OCCUPYWALLSTREET = (By.ID, 'name-space-5')
    ORGANIZATION = (By.ID, 'name-space-6')
