message = {
    ...
    'Camp_Forum': {
        'CAMP_FORUM_TITLE': 'Camp Forum',
        'THREAD_PAGE_TITLE': 'Create a new thread',
        'BLANK_TITLE_ERROR': 'Please enter title!',
        'DUPLICATE_THREAD': 'Thread title must be unique!',
        'EDIT_THREAD_TITLE': 'Edit title of the thread',
    ...
    'Add_News': {
        'ADD_NEWS_PAGE_TITLE': 'Add News',
        'NEWS_ADDED': 'News added by sania_talentelgia',
    ...
    'Add_Camp_Statement': {
        'ADD_CAMP_STATEMENT_TITLE': 'Add Camp Statement',
